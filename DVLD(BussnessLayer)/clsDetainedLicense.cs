...
namespace DVLD_BussnessLayer_
{
    public class clsDetainedLicense
    {
        ...
        public clsBussniessUser CreatedByUserInfo { set; get; }
        public bool IsReleased { set; get; }
        public DateTime ReleaseDate { set; get; }
        public int ReleasedByUserID { set; get; }
        public clsBussniessUser ReleasedByUserInfo { set; get; }
...

        {
            ...
            this.CreatedByUserInfo = clsBussniessUser.GetUserById(this.CreatedByUserID);
            this.IsReleased = IsReleased;
            this.ReleaseDate = ReleaseDate;
            this.ReleasedByUserID = ReleasedByUserID;
            this.ReleaseApplicationID = ReleaseApplicationID;
            this.ReleasedByUserInfo= clsBussniessUser.GetUserById(this.ReleasedByUserID);
            Mode = enMode.Update;
        }
